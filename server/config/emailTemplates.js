...
export const MEMBERSHIP_REQUEST_DECISION_TEMPLATE = `
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <title>Membership Request Decision</title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600&display=swap" rel="stylesheet" type="text/css">
                ...
                <td class="main-content">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px; font-size: 14px; line-height: 150%;">
                          Your request to join <strong>{{orgName}}</strong> has been <strong>{{status}}</strong>.
                        </td>
                      </tr>
                      {{reviewNotesSection}}
                      <tr>
                        <td style="padding: 16px 0 0; font-size: 14px; line-height: 150%; color: #64748B;">
                          Thank you for using MeetOnMemory.
                        </td>
                      </tr>
                    </tbody>
                  </table>
